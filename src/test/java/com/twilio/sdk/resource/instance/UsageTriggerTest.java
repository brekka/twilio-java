...
public class UsageTriggerTest extends BasicRequestTester {
    ...
    public void testListingUsageTrigger() throws Exception {
        ...
        UsageTriggerList usageTriggers = this.client.getAccount().getUsageTriggers();
    ...
    public void testCreateUsageTrigger() throws Exception {
        ...
        Account mainAccount = this.client.getAccount();
    ...
    public void testDeleteUsageTrigger() throws Exception {
        ...
        UsageTrigger ut = new UsageTrigger(this.client, "UT5f539674e9b84c2ba39a4156f264a347");
        assertTrue(ut.delete());
    }

    @Test(expected = TwilioRestException.class)
    public void testDeleteErrorUsageTrigger() throws Exception {
        setExpectedServerAnswer("404onUsageTrigger.json"); // err this is actually json but this stupid classloader wont take the .json extension
        setExpectedServerReturnCode(404);
        setExpectedServerContentType("application/json");
        UsageTrigger ut = new UsageTrigger(this.client, "UT0123456789abcdef0123456789abcdef");
        ut.delete();
    }
